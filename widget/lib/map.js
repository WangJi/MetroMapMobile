...
/***/ (function(module, exports, __webpack_require__) {
	...
	api.addEventListener({
	    ...
	    _Project2.default.getProjectsInCity().then(function (city) {
	        _loadPublicMap2.default.loadProjects(city);
	    });
	});
	...
	api.addEventListener({
	    ...
	    _Project2.default.getLine().then(function (line) {
	        _loadPublicMap2.default.loadLine(line);
	    });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var service = {
	    ...
	    _findCenter: function _findCenter(cityName) {
	        //城市的中心,如果有项目的话,取项目的平均值,否则用的是预定义的城市的中心
	        var city = _predefinedCityList2.default.find(function (s) {
	    ...
	    _averageCenter: function _averageCenter() {
	        //取makerList的中心
	        var sumLon = 0;
	        var sumLat = 0;
	    ...
	    loadLine: function loadLine(line) {
	        var _this = this;
	        var annotations = [];
	    ...
	    loadProjects: function loadProjects(city) {
	        //按城市加载项目
	        var _this = this;
	        var annotations = [];
	        _this.clearAnnotations();
	    ...
	    _halfScreen: function _halfScreen() {
	        //半屏幕
	        service.map.setRect({
	            rect: {
	                x: 0,
	    ...
	    _loadWidgets: function _loadWidgets() {
	        //地图的附加层,地图是内置的,只能添加frame附加层到其上面,当做是地图的控件,依靠事件来相互通信,
	        api.openFrame({
	            name: 'mapSearchBar_frm',
